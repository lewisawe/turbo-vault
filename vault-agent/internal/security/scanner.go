...
anCertificates performs certificate security scanning
...
ecurityScannerImpl) scanExposedSecrets(ctx context.Context, targets []string) []*SecurityFinding {
	findings := []*SecurityFinding{}
...
unc (s *SecurityScannerImpl) scanGoDependencies(ctx context.Context) []*DependencyResult {
